...
file = "../SentiNews/SentiNews_sentence-level.txt"
with open(file, encoding="utf-8") as f:
    header = f.readline()

    for line in f:
        splitted = line.split("\t")
        print("Sentence: ",splitted[2])
        avg_sentiment = splitted[10]
        sd_sentiment = splitted[11]
        sentiment = splitted[12]
        content = splitted[3]
        ...
        test = cursor.execute(query, [regu])
...
np.save("../SentiNews/senLevel_sentiment_v1.npy", result)